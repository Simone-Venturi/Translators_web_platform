...
export const API_LOGIN_ENDPOINT = process.env.VUE_APP_LOGIN_ENDPOINT,
    ...
    API_CREATE_PARALLELTEXT_ENDPOINT = process.env.VUE_APP_PARALLEL_TEXT_CREATE,
    ...
    API_LOAD_RESOURCE_DATASET_ENDPOINT = process.env.VUE_APP_DATASET_LOAD_RESOURCE,
    API_CHECK_DOWNLOAD_SIZE_DATASET_ENDPOINT = process.env.VUE_APP_DATASET_CHECK_DOWNLOAD_SIZE,
    API_DOWNLOAD_SIZE_DATASET_ENDPOINT = process.env.VUE_APP_DATASET_DOWNLOAD_SIZE,
...
export default {
    ...
    API_CREATE_PARALLELTEXT_ENDPOINT,
